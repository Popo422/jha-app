...
export default function AdminEditStartOfDayV2Page() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error('Error updating start of day report:', error);
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">Loading start of day report...</p>
            </div>
          </div>
        </main>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center py-12">
              <p className="text-red-600 dark:text-red-400">Start of day report not found.</p>
