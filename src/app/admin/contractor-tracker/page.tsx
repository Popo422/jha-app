...
export default function ContractTrackerPage() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Contractor Tracker</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Manage and monitor all contractor agreements</p>
      </div>
    </div>
  )
}