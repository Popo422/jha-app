...
export default function CreateIncidentReport({ onBack }: CreateIncidentReportProps) {
  ...
  const handleCreate = useCallback(async () => {
    try {
      ...
      if (!formData.completedBy || !formData.projectName || !formData.injuredParty || !formData.reportDate || !formData.companySubcontractor) {
      ...
      const result = await createIncident({
        ...
        dateOfIncident: formData.incidentDate || formData.reportDate,
        company: formData.companySubcontractor,
        incidentType: 'incident-report',
        formData: formData
      }).unwrap();
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold">{t('common.create')} {t('forms.incidentReport')}</h2>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <SignatureModal
                  ...
                  modalTitle={`${t('forms.incidentReport')} - ${t('forms.digitalSignature')} (Admin Create)`}
