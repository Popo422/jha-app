...
const styles = StyleSheet.create({
  ...
  classificationCol: { width: '11%', padding: 2, borderRightWidth: 1, borderRightColor: '#ccc' },
  typeCol: { width: '3%', padding: 0, borderRightWidth: 1, borderRightColor: '#ccc', textAlign: 'center', flexDirection: 'column' },
  dayCell: { width: '7%', padding: 0, borderRightWidth: 1, borderRightColor: '#ccc', textAlign: 'center', flexDirection: 'column' },
  mergedDayHeader: { width: '49%', padding: 2, borderRightWidth: 1, borderRightColor: '#ccc', textAlign: 'center', justifyContent: 'center', alignItems: 'center' },
  dayCellRow: { 
    flex: 1, 
    borderBottomWidth: 1, 
    borderBottomColor: '#ccc', 
  ...
  totalCol: { width: '8%', padding: 0, borderRightWidth: 1, borderRightColor: '#ccc', flexDirection: 'column' },
  rateCol: { width: '8%', padding: 0, borderRightWidth: 1, borderRightColor: '#ccc', flexDirection: 'column' },
  amountCol: { width: '10%', padding: 0, flexDirection: 'row' },
...
const PayrollPDFDocument = ({ data }: { data: PayrollReportData }) => (
