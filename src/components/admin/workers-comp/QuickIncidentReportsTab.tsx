...
interface QuickIncidentReportsTabProps {
  projectId?: string;
}

export default function QuickIncidentReportsTab({ projectId }: QuickIncidentReportsTabProps) {
  ...
  const { data: incidentsData, refetch, isLoading, isFetching } = useGetIncidentsQuery({
    ...
    incidentType: 'quick-incident-report', // Only quick incident reports
